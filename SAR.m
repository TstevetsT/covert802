...
dataSymbolsInc22=dataSymbolsInc(length(dataSymbolsInc)/2+1:end);
dataModc21 = qammod(dataSymbolsInc21,Mc,0,'gray'); % Gray coding, phase offset = 0
dataModc22 = qammod(dataSymbolsInc22,Mc,1,'gray'); % Gray coding, phase offset = 0
dataModc2=[dataModc21;dataModc22];
dataModc2=dataModc2/2;
dataModj2=[dataMod;dataModc2];
EbNo = 10;
snr = EbNo + 10*log10(k) - 10*log10(numSamplesPerSymbol);
receivedSignal = awgn(dataMod,snr,'measured');
receivedSignalc = awgn(dataModc,snr,'measured');
receivedSignalj = awgn(dataModj,snr,'measured');
receivedSignalj2 = awgn(dataModj2,snr,'measured');
...
sPlotFigj2 = scatterplot(receivedSignalj2,1,0,'g.');
hold on
scatterplot(dataModj2,1,0,'k*',sPlotFigj2)
dataSymbolsOutc = qamdemod(receivedSignalc, Mc);
out=[dataSymbolsInc dataSymbolsOutc]
